...
if __name__ == '__main__':
    ...
    print(f"\nModel Status:")
    print(f"   Price Model:     {'Loaded' if price_model is not None else 'Using Fallback'}")
    print(f"   Recommendations: {'Loaded' if recommendation_rules is not None else 'Using Fallback'}")
